...
const DEFAULT_MAIN_ITEMS = [
  ...
  "Sit, boy! You MUST include 1 card featuring a chair.",
  "They Really Should Reprint This Include up to 3 nonland cards with no reprints (not counting secret lairs) ",
  "NEW SECRET LAIR ALERT! - Include up to 3 nonland cards from any Secret Lair Drop to your deck.",
  "Shock and Awe - Include any number of Shock Lands.",
  "WTF MDFC OMG! Add up to 3 modal double-faced cards in your deck. ",
  "Bring the Pain! - Include any number of pain lands to your deck.",
  "Planeswalker Party! - Include up to 3 Planeswalkers.",
  "Planeshifted - You MUST include one card from each of the four 'drafted sets' in your deck. ",
  "Understudy - Add one legendary creature card that could be a second commander to your deck.",
  "EDH Rekt - Add up to 2 cards from  the 'High Synergy Cards category of your commander's EDHRec page",
  "Pimp My Ride - Go budgetless on the treatments of your artifacts (keeping the same cards).",
  "Pimp My High Tide - Go budgetless on the treatments of your instants and sorcerys (keeping the same cards).",
  "Pimp My Countryside - Go budgetless on the treatments for your lands (keeping the same cards).",
  "Pimp My Guys - Go budgetless on  the treatments of your creatures (keeping the same cards).",
  "I've been here the whole time! Add up to 1 'Game Changer' to your deck. ",
  "Far Traveler - Add up to 3 rare lands to your deck from any set.",
  "Common Collector - You may include any commons from any of the 'drafted sets' in your decklist.",
  "Uncommons Unending - You may include any number of uncommons from any of the 'drafted sets' in your decklist. ",
  "Rares Robust - You may include up to 10 rares from any of the 'drafted sets' in your decklist. (Including the 'Stellar Sights and 'Enchanting Tales Bonus Sheets'",
  "Mythic Mastery - You may include up to 5 mythics from any number of mythic rares from any of the 'drafted sets' in your decklist. (Including the 'Stellar Sights and 'Enchanting Tales Bonus Sheets')",
  "I thought this was a singleton format? - You may include up to one of the following cards: [[Enlightened Tutor]], [[Gamble]], [[Mystical Tutor]], [[Vampiric Tutor]], [[Worldly Tutor]].",
  "Tuesday Night! - You MUST include one card from Commander Legends: Battle for Baldur's Gate",
  "That's Hot. You MUST include a card all players agree is hot.",
  "F- This - All players gain an emblem at the beginning of the game that states 'Once per game you may discard a card, if you do, draw a card.'",
  "Coveted Jewel - All players MUST include a [[Coveted Jewel]] in their decklist.",
  "I love democracy! - You MUST Include a card that requires voting in your decklist.",
